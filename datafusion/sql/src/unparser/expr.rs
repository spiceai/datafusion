...
impl Unparser<'_> {
    ...
    fn render_expr_to_sql(&self, expr: &Expr) -> Result<ast::Expr> {
        ...
        //
        // `expr_to_sql_with_nesting` is the shared stack-growth checkpoint, so
        // route through it here rather than duplicating the guard.
        let root_expr = self.expr_to_sql_with_nesting(expr)?;
...
mod tests {
    ...
    use crate::unparser::dialect::{
        ...
        ScalarFnToSqlHandler, TimezoneCastStyle,
    };
