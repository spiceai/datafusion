...
use datafusion_common::{config_err, DataFusionError, Result, ToDFSchema as _};
...
impl ListingTable {
    ...
    fn metadata_columns(&self) -> &[MetadataColumn] {
...
impl TableProvider for ListingTable {
    ...
    async fn scan(
        ...
        let metadata_cols = self.metadata_columns().to_vec();
